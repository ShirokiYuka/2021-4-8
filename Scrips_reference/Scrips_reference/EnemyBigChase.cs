...
public class EnemyBigChase : MonoBehaviour {

    public GameObject targetPlayer;

    [Header("Set DethEnemy Prefab")]
    public GameObject dethEnemyPrefab2;
    [Header("Set AttackEnemy Prefab")]
    public GameObject attackEnemyPrefab2;
    ...
    public void OnCollisionEnter(Collision collision)
    {
        if (collision.gameObject.CompareTag("Bullet"))
        {
            ...
            if(hitCount >= 5)
            {
                ...
                GameObject dethEnemy = Instantiate(dethEnemyPrefab2);
        ...
        }else if (collision.gameObject.CompareTag("BulletPos"))
        {
            ...
            GameObject attackEnemy = Instantiate(attackEnemyPrefab2);
